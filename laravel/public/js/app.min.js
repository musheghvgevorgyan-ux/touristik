...
(function () {
    ...
    // Mobile: dedicated toggle button for submenu
    var toursLink = navLinks.querySelector('.nav-dropdown > a');

    function toggleSubmenu(e) {
        e.stopPropagation();
        submenu.classList.toggle('open');
        if (submenuToggle) submenuToggle.classList.toggle('open');
    }
    ...
    // Mobile: Tours text also toggles submenu
    if (toursLink && submenu) {
    ...
    // Close menu when any nav link is clicked (except Tours link on mobile)
    navLinks.querySelectorAll('a').forEach(function (link) {
        if (link === toursLink) return;
