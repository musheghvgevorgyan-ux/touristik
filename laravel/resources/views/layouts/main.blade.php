...
<body>
    ...
    <!-- WhatsApp Button -->
    <a href="https://wa.me/37410123456?text=Hi!%20I%27m%20interested%20in%20your%20tours" class="whatsapp-fab" target="_blank" aria-label="Chat on WhatsApp">
    ...
    <style>
        .whatsapp-fab { position: fixed; bottom: 30px; left: 20px; width: 56px; height: 56px; border-radius: 50%; background: #25d366; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(37,211,102,0.4); z-index: 999; transition: transform 0.3s; animation: pulse-call 2s infinite; }
