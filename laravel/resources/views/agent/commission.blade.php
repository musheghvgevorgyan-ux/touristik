...
@section('title', 'Commission Report - Touristik')
            ...
            <tbody>
                ...
                @else
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{ $b['currency'] ?? 'USD' }} {!! number_format((float)($b['net_price'] ?? 0), 2) !!}</td>
                        <td class="text-right">{{ $b['currency'] ?? 'USD' }} {!! number_format((float)($b['sell_price'] ?? 0), 2) !!}</td>
                        <td class="text-right commission-col">{{ $b['currency'] ?? 'USD' }} {!! number_format((float)($b['commission'] ?? 0), 2) !!}</td>
