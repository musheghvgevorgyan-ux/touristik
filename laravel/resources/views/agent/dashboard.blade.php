...
@section('title', 'Agent Dashboard - Touristik')
...
<div class="agent-portal">
    <div class="agent-header">
        ...
        <span class="agent-status agent-status-{{ $agency['status'] ?? 'pending' }}">
            {{ ucfirst($agency['status'] ?? 'pending') }}
        </span>
    </div>
    ...
    <div class="agent-info-bar">
        ...
        <div class="agent-info-item">
            ...
            <span class="info-value">{{ ucfirst($agency['payment_model'] ?? 'markup') }}</span>
        </div>
        <div class="agent-info-item">
