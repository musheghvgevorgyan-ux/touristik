...
@section('title', 'Profile - Touristik')
    ...
    <form method="POST" action="/account/profile">
        ...
        <div class="profile-card reveal">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone" value="{{ old('phone', $user['phone'] ?? '') }}" placeholder="+374 XX XXXXXX">
            </div>
        </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="language" name="language">
                        @php $lang = old('language', $user['language'] ?? 'en'); @endphp
                ...
                <div class="form-group">
                    ...
                    <select id="currency" name="currency">
                        @php $curr = old('currency', $user['currency'] ?? 'USD'); @endphp
