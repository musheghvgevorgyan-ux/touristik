...
@section('title', 'Wishlist - Touristik')
                    ...
                    <div class="wishlist-card-body">
                        ...
                        @if($price !== null)
                            <div class="wishlist-price">
                                {!! "$" . number_format((float, 2) $price, $currency) !!}
                                <span class="price-label"> / night</span>
                            </div>
                        @endif
                        @if($savedAt)
                            <div class="wishlist-meta">Saved {{ \Carbon\Carbon::parse($savedAt)->format('M j, Y') }}</div>
                        @endif
                        <div class="wishlist-card-actions">
                            <a href="{{ $viewUrl }}" class="btn-view" data-t="view_details">View</a>
