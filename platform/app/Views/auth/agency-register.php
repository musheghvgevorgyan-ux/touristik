        ...
        <form method="POST" action="/register/agency">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="company_name" name="company_name" value="<?= View::old('company_name') ?>" placeholder="Your travel agency name" required autofocus>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="legal_name">Legal Name</label>
                        <input type="text" id="legal_name" name="legal_name" value="<?= View::old('legal_name') ?>" placeholder="Registered legal name">
                    </div>
                    <div class="form-group">
                        <label for="tax_id">Tax ID / VAT</label>
                        <input type="text" id="tax_id" name="tax_id" value="<?= View::old('tax_id') ?>" placeholder="Tax identification number">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" id="company_email" name="company_email" value="<?= View::old('company_email') ?>" placeholder="info@youragency.com" required>
                    </div>
                    <div class="form-group">
                        <label for="company_phone">Company Phone</label>
                        <input type="tel" id="company_phone" name="company_phone" value="<?= View::old('company_phone') ?>" placeholder="+374 XX XXXXXX">
                    </div>
                </div>

                <div class="form-group">
                    <label for="address">Company Address</label>
                    <textarea id="address" name="address" placeholder="Street address, city, country"><?= View::old('address') ?></textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="first_name" name="first_name" value="<?= View::old('first_name') ?>" placeholder="John" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="<?= View::old('email') ?>" placeholder="you@youragency.com" required>
