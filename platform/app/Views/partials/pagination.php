...
<div class="admin-pagination">
    ...
    <div class="pagination-links">
        <?php if ($currentPage > 1): ?>
            <a href="<?= View::e($baseUrl) ?>?page=<?= $currentPage - 1 ?>" class="pagination-btn pagination-prev" aria-label="Previous page">&laquo; Prev</a>
        <?php else: ?>
        ...
        if ($start > 1): ?>
            <a href="<?= View::e($baseUrl) ?>?page=1" class="pagination-btn">1</a>
            <?php if ($start > 2): ?>
        ...
        <?php for ($i = $start; $i <= $end; $i++): ?>
            ...
            <?php else: ?>
                <a href="<?= View::e($baseUrl) ?>?page=<?= $i ?>" class="pagination-btn"><?= $i ?></a>
            <?php endif; ?>
        <?php endfor; ?>
        ...
        <?php if ($end < $totalPages): ?>
            <?php if ($end < $totalPages - 1): ?>
                <span class="pagination-ellipsis">&hellip;</span>
            <?php endif; ?>
            <a href="<?= View::e($baseUrl) ?>?page=<?= $totalPages ?>" class="pagination-btn"><?= $totalPages ?></a>
        <?php endif; ?>

        <?php if ($currentPage < $totalPages): ?>
            <a href="<?= View::e($baseUrl) ?>?page=<?= $currentPage + 1 ?>" class="pagination-btn pagination-next" aria-label="Next page">Next &raquo;</a>
        <?php else: ?>
...
<style>
    ...
    @media (max-width: 600px) {
        .admin-pagination { flex-direction: column; align-items: center; }
    }
</style>
<?php endif; ?>
