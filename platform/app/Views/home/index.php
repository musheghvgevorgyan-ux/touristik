...
<section id="home" class="hero">
    ...
    <div class="hero-content">
        <h1 class="hero-typed" data-t="hero_title"><?= View::e($heroTitle) ?></h1>
        <p class="hero-subtitle-fade" data-t="hero_subtitle"><?= View::e($heroSubtitle) ?></p>
...
<section id="destinations" class="destinations reveal has-blobs">
    ...
    <div class="card-grid">
        ...
        <div class="card reveal-scale">
            <a href="/destinations/<?= View::e($dest['slug']) ?>">
                <?php if (!empty($dest['image_url'])): ?>
                <div class="card-image lazy-bg" data-bg="<?= View::e($dest['image_url']) ?>"></div>
                <?php else: ?>
                <div class="card-image" style="background-color: <?= View::e($dest['color']) ?>;">
                    <span class="card-emoji"><?= View::e($dest['emoji']) ?></span>
                </div>
                <?php endif; ?>
                <div class="card-body">
                    <h3 data-t="dest_name_<?= $dest['id'] ?>"><?= View::e($dest['name']) ?></h3>
                    <p data-t="dest_desc_<?= $dest['id'] ?>"><?= View::e($dest['description']) ?></p>
