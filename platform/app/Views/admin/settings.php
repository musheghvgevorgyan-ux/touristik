...
<form method="POST" action="/admin/settings" class="settings-form">
    ...
    <div class="settings-section">
        ...
        <div class="setting-row">
            ...
            <input type="text" name="settings[site_name]" id="set-site_name" value="<?= View::e($settings['site_name'] ?? '') ?>">
            <span class="setting-desc">The name shown in the browser tab and header.</span>
        </div>
        <div class="setting-row">
            <label for="set-site_tagline">Tagline</label>
            <input type="text" name="settings[site_tagline]" id="set-site_tagline" value="<?= View::e($settings['site_tagline'] ?? '') ?>">
            <span class="setting-desc">A short tagline for the site.</span>
        </div>
        <div class="setting-row">
            <label for="set-hero_title">Hero Title</label>
            <input type="text" name="settings[hero_title]" id="set-hero_title" value="<?= View::e($settings['hero_title'] ?? '') ?>">
            <span class="setting-desc">Main heading on the homepage hero section.</span>
        </div>
        <div class="setting-row">
            <label for="set-hero_subtitle">Hero Subtitle</label>
            <textarea name="settings[hero_subtitle]" id="set-hero_subtitle"><?= View::e($settings['hero_subtitle'] ?? '') ?></textarea>
    ...
    <div class="settings-section">
        ...
        <div class="setting-row">
            ...
            <input type="email" name="settings[contact_email]" id="set-contact_email" value="<?= View::e($settings['contact_email'] ?? '') ?>">
        ...
        <div class="setting-row">
            ...
            <input type="text" name="settings[contact_phone]" id="set-contact_phone" value="<?= View::e($settings['contact_phone'] ?? '') ?>">
    ...
    <div class="settings-section">
        ...
        <div class="setting-row">
            ...
            <input type="number" name="settings[items_per_page]" id="set-items_per_page" min="5" max="100" value="<?= View::e($settings['items_per_page'] ?? '20') ?>">
    ...
    <div class="settings-section">
        ...
        <div class="setting-row">
            ...
            <input type="text" name="settings[ga_measurement_id]" id="set-ga_measurement_id" placeholder="G-XXXXXXXXXX" value="<?= View::e($settings['ga_measurement_id'] ?? '') ?>">
    ...
    <div class="settings-section">
        ...
        <div class="setting-row">
            ...
            <textarea name="settings[footer_text]" id="set-footer_text"><?= View::e($settings['footer_text'] ?? '') ?></textarea>
