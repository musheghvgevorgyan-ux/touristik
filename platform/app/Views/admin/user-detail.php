...
<div class="detail-grid">
    ...
    <div class="detail-card">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value"><?= View::e(($userDetail['first_name'] ?? '') . ' ' . ($userDetail['last_name'] ?? '')) ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Email</span>
            <span class="detail-value"><?= View::e($userDetail['email']) ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Phone</span>
            <span class="detail-value"><?= View::e($userDetail['phone'] ?? '-') ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Role</span>
            <span class="detail-value"><span class="badge badge-<?= View::e($userDetail['role']) ?>"><?= View::e(ucfirst($userDetail['role'])) ?></span></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Status</span>
            <span class="detail-value"><span class="badge badge-<?= View::e($userDetail['status'] ?? 'active') ?>"><?= View::e(ucfirst($userDetail['status'] ?? 'Active')) ?></span></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Agency</span>
            <span class="detail-value"><?= View::e($userDetail['agency_name'] ?? '-') ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Language</span>
            <span class="detail-value"><?= View::e(strtoupper($userDetail['language'] ?? 'en')) ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Currency</span>
            <span class="detail-value"><?= View::e(strtoupper($userDetail['currency'] ?? 'USD')) ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Last Login</span>
            <span class="detail-value"><?= !empty($userDetail['last_login_at']) ? View::date($userDetail['last_login_at'], 'M d, Y H:i') : 'Never' ?></span>
        </div>
        <div class="detail-row">
            <span class="detail-label">Registered</span>
            <span class="detail-value"><?= View::date($userDetail['created_at']) ?></span>
        </div>
    </div>
...
<div class="admin-table-wrap">
    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <?php else: ?>
                <?php foreach (array_slice($userBookings, 0, 10) as $b): ?>
                <tr>
                    <td><span class="ref-code"><?= View::e($b['reference']) ?></span></td>
                    <td><?= View::e(ucfirst($b['product_type'] ?? 'N/A')) ?></td>
                    <td><span class="badge badge-<?= View::e($b['status']) ?>"><?= View::e(ucfirst($b['status'])) ?></span></td>
                    <td><strong><?= View::e($b['currency'] ?? 'USD') ?> <?= number_format($b['sell_price'] ?? 0, 2) ?></strong></td>
...
<div class="detail-card">
    ...
    <?php else: ?>
        <?php foreach (array_slice($userActivity, 0, 20) as $activity): ?>
        <div class="activity-item">
            <div class="activity-dot"></div>
            <div>
                <div class="activity-text"><?= View::e($activity['action']) ?></div>
                <div class="activity-meta"><?= View::date($activity['created_at'], 'M d, Y H:i') ?></div>
            </div>
        </div>
        <?php endforeach; ?>
    <?php endif; ?>
