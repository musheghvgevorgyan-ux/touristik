...
<?php if (empty($reviews)): ?>
    <div class="empty-state">
        ...
        <p>No reviews found<?= $currentFilter ? ' with status "' . View::e($currentFilter) . '"' : '' ?>.</p>
    </div>
<?php else: ?>
    <div class="reviews-list">
        ...
        <div class="review-card">
            <div class="review-top">
                <div>
                    <div class="review-user"><?= View::e(($review['user_first_name'] ?? '') . ' ' . ($review['user_last_name'] ?? '')) ?></div>
                    <div class="review-product"><?= View::e($review['product_type'] ?? '') ?>: <?= View::e($review['product_name'] ?? '-') ?></div>
                </div>
                <div class="review-meta">
                    <span class="badge badge-<?= View::e($review['status'] ?? 'pending') ?>"><?= View::e(ucfirst($review['status'] ?? 'Pending')) ?></span>
                    <div class="review-date"><?= View::date($review['created_at']) ?></div>
                </div>
            </div>
            ...
            <?php if (!empty($review['title'])): ?>
                <div class="review-title"><?= View::e($review['title']) ?></div>
            <?php endif; ?>

            <div class="review-comment"><?= nl2br(View::e($review['comment'] ?? '')) ?></div>
