...
<form method="GET" action="/admin/users" class="admin-filter-bar">
    ...
    <div class="admin-filter-group">
        ...
        <input type="text" name="search" id="filter-search" placeholder="Name or email..." value="<?= View::e($filters['search'] ?? '') ?>">
    </div>
    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    <td><?= (int)$u['id'] ?></td>
                    <td><strong><?= View::e(($u['first_name'] ?? '') . ' ' . ($u['last_name'] ?? '')) ?></strong></td>
                    <td><span class="user-email"><?= View::e($u['email']) ?></span></td>
                    <td><span class="badge badge-<?= View::e($u['role']) ?>"><?= View::e(ucfirst($u['role'])) ?></span></td>
                    <td><span class="badge badge-<?= View::e($u['status'] ?? 'active') ?>"><?= View::e(ucfirst($u['status'] ?? 'Active')) ?></span></td>
                    <td><?= View::e($u['agency_name'] ?? '-') ?></td>
                    <td><?= !empty($u['last_login_at']) ? View::date($u['last_login_at'], 'M d, H:i') : 'Never' ?></td>
