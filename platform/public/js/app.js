...
// Prevent accidental content editing (some extensions/hosts inject contenteditable)
document.designMode = 'off';
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('[contenteditable]:not(input):not(textarea)').forEach(function (el) {
...
(function () {
    ...
    if (navControls) {
        navControls.querySelectorAll('.currency-opt, .lang-option').forEach(function (opt) {
    ...
    document.addEventListener('click', function (e) {
        ...
        if (!navLinks.contains(e.target) && !hamburger.contains(e.target) &&
            (!navControls || !navControls.contains(e.target))) {
            closeMenu();
        }
    });
})();
...
translations = {
    en: {
        ...
        tour_cat_ingoing: 'Ingoing Tours',
        tour_cat_ingoing_desc: 'Tours',
        tour_cat_outgoing: 'Outgoing Tours',
        tour_cat_outgoing_desc: 'Tours',
        tour_cat_transfer: 'Transfer',
        tour_cat_transfer_desc: 'Transfers',
        // Visa support
        ...
        // Admin bookings
        tab_bookings: 'Bookings', tab_performance: 'Performance',
        booking_title: 'Hotel Bookings', booking_no_bookings: 'No bookings yet.',
        booking_total: 'Total Bookings', booking_confirmed: 'Confirmed', booking_upcoming: 'Upcoming',
        booking_reference: 'Reference', booking_hotel: 'Hotel', booking_guest: 'Guest',
        booking_checkin: 'Check-in', booking_checkout: 'Check-out',
    ...
    ru: {
        ...
        // Tours
        tours_title: '\u0422\u0443\u0440\u044b',
        tours_subtitle: '\u041d\u0430\u0448\u0438 \u0442\u0443\u0440\u0438\u0441\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u0435 \u0443\u0441\u043b\u0443\u0433\u0438',
        tour_cat_ingoing: '\u0412\u044a\u0435\u0437\u0434\u043d\u044b\u0435 \u0442\u0443\u0440\u044b',
        tour_cat_ingoing_desc: '\u0422\u0443\u0440\u044b',
        tour_cat_outgoing: '\u0412\u044b\u0435\u0437\u0434\u043d\u044b\u0435 \u0442\u0443\u0440\u044b',
        tour_cat_outgoing_desc: '\u0422\u0443\u0440\u044b',
        tour_cat_transfer: '\u0422\u0440\u0430\u043d\u0441\u0444\u0435\u0440',
        tour_cat_transfer_desc: '\u0422\u0440\u0430\u043d\u0441\u0444\u0435\u0440\u044b',
        // Visa support
        ...
        // Admin bookings
        tab_bookings: '\u0411\u0440\u043e\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f', tab_performance: '\u041f\u0440\u043e\u0438\u0437\u0432\u043e\u0434\u0438\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c',
        booking_title: '\u0411\u0440\u043e\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u043e\u0442\u0435\u043b\u0435\u0439', booking_no_bookings: '\u0411\u0440\u043e\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0439 \u043f\u043e\u043a\u0430 \u043d\u0435\u0442.',
        booking_total: '\u0412\u0441\u0435\u0433\u043e \u0431\u0440\u043e\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0439', booking_confirmed: '\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u043e', booking_upcoming: '\u041f\u0440\u0435\u0434\u0441\u0442\u043e\u044f\u0449\u0438\u0435',
        booking_reference: '\u041d\u043e\u043c\u0435\u0440', booking_hotel: '\u041e\u0442\u0435\u043b\u044c', booking_guest: '\u0413\u043e\u0441\u0442\u044c',
        booking_checkin: '\u0417\u0430\u0435\u0437\u0434', booking_checkout: '\u0412\u044b\u0435\u0437\u0434',
    ...
    hy: {
        ...
        about_p2: '\u054f\u0561\u0580\u056b\u0576\u0565\u0580\u056b \u0583\u0578\u0580\u0571\u0578\u057e \u057f\u0578\u0582\u0580\u056b\u057d\u057f\u0561\u056f\u0561\u0576 \u0578\u056c\u0578\u0580\u057f\u0578\u0582\u0574, \u0574\u0565\u0576\u0584 \u0585\u0563\u0576\u0565\u056c \u0565\u0576\u0584 \u0570\u0561\u0566\u0561\u0580\u0561\u057e\u0578\u0580 \u0573\u0561\u0574\u0583\u0578\u0580\u0564\u0576\u0565\u0580\u056b\u0576 \u0563\u057f\u0576\u0565\u056c \u056b\u0580\u0565\u0576\u0581 \u0565\u0580\u0561\u0566\u0561\u0576\u0584\u056b \u0578\u0582\u0572\u0572\u0578\u0582\u0569\u0575\u0578\u0582\u0576\u0568\u0589 \u053c\u056b\u0576\u056b \u0570\u0561\u0576\u0563\u057d\u057f\u0561\u0581\u0578\u0572 \u056e\u0578\u057e\u0561\u0583\u0576\u0575\u0561 \u0570\u0561\u0576\u0563\u056b\u057d\u057f, \u0569\u0565 \u0561\u056f\u057f\u056b\u057e \u0584\u0561\u0572\u0561\u0584\u0561\u0575\u056b\u0576 \u0561\u0580\u056f\u0561\u056e \u2014 \u0574\u0565\u0576\u0584 \u056f\u0585\u0563\u0576\u0565\u0576\u0584\u0589',
        // Destinations
        ...
        // Tours
        tours_title: '\u054f\u0578\u0582\u0580\u0565\u0580',
        tours_subtitle: '\u0544\u0565\u0580 \u057f\u0578\u0582\u0580\u056b\u057d\u057f\u0561\u056f\u0561\u0576 \u056e\u0561\u057c\u0561\u0575\u0578\u0582\u0569\u0575\u0578\u0582\u0576\u0576\u0565\u0580\u0568',
        tour_cat_ingoing: '\u0546\u0565\u0580\u0563\u0576\u0561 \u057f\u0578\u0582\u0580\u0565\u0580',
        tour_cat_ingoing_desc: '\u054f\u0578\u0582\u0580\u0565\u0580',
        tour_cat_outgoing: '\u0531\u0580\u057f\u0561\u0563\u0576\u0561 \u057f\u0578\u0582\u0580\u0565\u0580',
        tour_cat_outgoing_desc: '\u054f\u0578\u0582\u0580\u0565\u0580',
        tour_cat_transfer: '\u054f\u0580\u0561\u0576\u057d\u0586\u0565\u0580',
        tour_cat_transfer_desc: '\u054f\u0580\u0561\u0576\u057d\u0586\u0565\u0580\u0576\u0565\u0580',
        // Visa support
        ...
        partners_subtitle: '\u054e\u057d\u057f\u0561\u0570\u0565\u056c\u056b \u0561\u057c\u0561\u057b\u0561\u057f\u0561\u0580 \u0561\u057e\u056b\u0561\u0568\u0576\u056f\u0565\u0580\u0578\u0582\u0569\u0575\u0578\u0582\u0576\u0576\u0565\u0580\u056b \u0587 \u0570\u0575\u0578\u0582\u0580\u0561\u0576\u0578\u0581\u0576\u0565\u0580\u056b \u056f\u0578\u0572\u0574\u056b\u0581',
        // Footer & Contact info
        ...
        faq_a1: '\u0555\u0563\u057f\u0561\u0563\u0578\u0580\u056e\u0565\u0584 \u0574\u0565\u0580 \u0563\u056c\u0561\u057e\u0578\u0580 \u0567\u057b\u056b \u0578\u0580\u0578\u0576\u0574\u0561\u0576 \u0571\u0587\u0561\u0569\u0565\u0580\u0569\u056b\u0576 \u056f\u0561\u0574 \u0564\u056b\u0574\u0565\u0584 \u0574\u0565\u0566 \u0570\u0565\u057c\u0561\u056d\u0578\u057d\u0578\u057e \u056f\u0561\u0574 \u0567\u056c-\u0583\u0578\u057d\u057f\u0578\u057e:',
        faq_q2: '\u0534\u0578\u0582\u0584 \u057e\u056b\u0566\u0561\u0575\u056b\u0576 \u0561\u057b\u0561\u056f\u0581\u0578\u0582\u0569\u0575\u0578\u0582\u0576 \u0565\u0584 \u057f\u0580\u0561\u0574\u0561\u0564\u0580\u0578\u0582\u0574?',
        faq_a2: '\u0531\u0575\u0578! \u0544\u0565\u0576\u0584 \u0561\u057c\u0561\u057b\u0561\u0580\u056f\u0565\u0576\u0584 \u056c\u056b\u0561\u0580\u056a\u0565\u0584 \u057e\u056b\u0566\u0561\u0575\u056b\u0576 \u0561\u057b\u0561\u056f\u0581\u0578\u0582\u0569\u0575\u0578\u0582\u0576\u055d \u0576\u0565\u0580\u0561\u057c\u0575\u0561\u056c \u0570\u0580\u0561\u057e\u0565\u0580\u0561\u0563\u0580\u0565\u0580 \u0587 \u0567\u056c\u0565\u056f\u057f\u0580\u0578\u0576\u0561\u0575\u056b\u0576 \u057e\u056b\u0566\u0561\u0575\u056b \u0585\u0563\u0576\u0578\u0582\u0569\u0575\u0578\u0582\u0576:',
        faq_q3: '\u053b\u0576\u0579 \u057e\u0573\u0561\u0580\u0574\u0561\u0576 \u0565\u0572\u0561\u0576\u0561\u056f\u0576\u0565\u0580 \u0565\u0584 \u0568\u0576\u0564\u0578\u0582\u0576\u0578\u0582\u0574?',
        faq_a3: '\u053f\u0561\u0576\u056d\u056b\u056f (AMD, USD, EUR, RUB), \u0562\u0561\u0576\u056f\u0561\u0575\u056b\u0576 \u0583\u0578\u056d\u0561\u0576\u0581\u0578\u0582\u0574\u0576\u0565\u0580 \u0587 Visa/MasterCard \u0584\u0561\u0580\u057f\u0565\u0580:',
        faq_q4: '\u053f\u0561\u0580\u0565\u056c\u056b\u055e \u0567 \u0579\u0565\u0572\u0561\u0580\u056f\u0565\u056c \u056f\u0561\u0574 \u0583\u0578\u056d\u0565\u056c \u0561\u0574\u0580\u0561\u0563\u0580\u0578\u0582\u0574\u0568?',
        faq_a4: '\u054a\u0561\u0575\u0574\u0561\u0576\u0576\u0565\u0580\u0568 \u056f\u0561\u056d\u057e\u0561\u056e \u0565\u0576 \u0561\u057e\u056b\u0561\u0568\u0576\u056f\u0565\u0580\u0569\u056b\u0581 \u0587 \u0570\u0575\u0578\u0582\u0580\u0561\u0576\u0578\u0581\u056b\u0581: \u0534\u056b\u0574\u0565\u0584 \u0574\u0565\u0580 24/7 \u0561\u057b\u0561\u056f\u0581\u0578\u0582\u0569\u0575\u0561\u0576:',
        faq_q5: '\u0534\u0578\u0582\u0584 \u056f\u0561\u0566\u0574\u0561\u056f\u0565\u0580\u056f\u0578\u0582\u0574 \u0565\u0584 \u056d\u0574\u0562\u0561\u056f\u0561\u0575\u056b\u0576 \u056f\u0561\u0574 \u056f\u0578\u0580\u056f\u0578\u0580\u0561\u057f\u056b\u057e \u0573\u0561\u0574\u0583\u0578\u0580\u0576\u0565\u0580?',
        faq_a5: '\u0531\u0576\u056f\u0561\u0575\u0574\u0561\u0576! \u0544\u0565\u0576\u0584 \u0574\u0561\u057d\u0576\u0561\u0563\u056b\u057f\u0561\u0581\u0578\u0582\u0574 \u0565\u0576\u0584 \u056d\u0574\u0562\u0561\u056f\u0561\u0575\u056b\u0576 \u057f\u0578\u0582\u0580\u0565\u0580\u056b \u0587 MICE \u0574\u056b\u057b\u0578\u0581\u0561\u057c\u0578\u0582\u0574\u0576\u0565\u0580\u056b \u057e\u0580\u0561:',
        breadcrumb_home: '\u0533\u056c\u056d\u0561\u057e\u0578\u0580',
        recently_viewed: '\ud83d\udc41 \u054e\u0565\u0580\u057b\u0565\u0580\u057d \u0564\u056b\u057f\u0561\u056e',
        // Admin bookings
        tab_bookings: 'Ամրագրումներ', tab_performance: 'Կատարողականություն',
        booking_title: 'Հյուրանոցների ամրագրումներ', booking_no_bookings: 'Ամրագրումներ դեռ չկան:',
        booking_total: 'Ընդամենը ամրագրում', booking_confirmed: 'Հաստատված', booking_upcoming: 'Առաջիկա',
        booking_reference: 'Հղում', booking_hotel: 'Հյուրանոց', booking_guest: 'Հյուր',
        booking_checkin: 'Ժամանում', booking_checkout: 'Մեկնում',
...
(function () {
    ...
    // Fix back button: reset transition classes when page is restored from cache
