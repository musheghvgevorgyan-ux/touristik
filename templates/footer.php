    ...
    <footer>
        ...
        <div class="footer-social">
            ...
            <div class="social-links">
                ...
                <a href="https://www.facebook.com/touristik.am" target="_blank" rel="noopener" aria-label="Facebook">
    ...
    <div class="social-float">
        ...
        <a href="https://www.facebook.com/touristik.am" target="_blank" rel="noopener" class="social-float-btn social-facebook" aria-label="Facebook">
    ...
    <script src="js/script<?= file_exists(__DIR__ . '/../js/script.min.js') ? '.min' : '' ?>.js?v=<?= time() ?>"></script>
    <script>
